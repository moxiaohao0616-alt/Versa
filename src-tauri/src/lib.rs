...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            open_repo, scan_workspace, git_init_repo, get_changed_files_only, get_dirty_submodule_files, list_submodule_names, check_submodule_dirty, save_progress, get_diff, get_history, get_file_history, get_block_history,
